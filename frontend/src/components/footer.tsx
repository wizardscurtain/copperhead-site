  ...
  <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a href="mailto:contact@copperheadci.com" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-2 opacity-50 cursor-not-allowed">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Copperhead Consulting Inc. All rights reserved. • Veteran Owned and Operated
          </p>
        </div>
      </div>
    </footer>
